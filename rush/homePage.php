    ...
    //echo $count;
        ...
        else
        {
            ...
            if($row = mysqli_fetch_array($res)) {
                echo '
                <div align="center">
                <form class="commentForm" method="POST" action="adminPage.php">
                                        
                    <input type="hidden" name="loginEmail" value ='.$_POST["loginEmail"].' />
                    <input type="hidden" name="loginPass" value ='.$_POST["loginPass"].' />
                    <button class="btn btn-outline-secondary btn btn-lrg" type="submit" value="Profile" name="submitProfilePage">Admin Page</button>
                </form>
                </div>
